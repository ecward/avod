...
class BevOnlyAvodModel(model.DetectionModel):
    ##############################
    ...
    def __init__(self, model_config, train_val_test, dataset):
        ...
        super(BevOnlyAvodModel, self).__init__(model_config)
        ...
        # Create the BevOnlyRpnModel
        self._rpn_model = BevOnlyRpnModel(model_config, train_val_test, dataset)
    ...
    def build(self):
        ...
        top_anchors = prediction_dict[BevOnlyRpnModel.PRED_TOP_ANCHORS]
        ground_plane = rpn_model.placeholders[BevOnlyRpnModel.PL_GROUND_PLANE]

        class_labels = rpn_model.placeholders[BevOnlyRpnModel.PL_LABEL_CLASSES]
        ...
        anchors_gt = rpn_model.placeholders[BevOnlyRpnModel.PL_LABEL_ANCHORS]
        if self._box_rep in ['box_3d', 'box_4ca']:
            boxes_3d_gt = rpn_model.placeholders[BevOnlyRpnModel.PL_LABEL_BOXES_3D]
